...
For fastest initial diagnosis, first check [state-model](state-model.md#8-patterns-prone-to-stalls-initial-diagnosis).
...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | ---------------------------------------------------- |
| `queued` stuck                    | [state-model](state-model.md#8-patterns-prone-to-stalls-initial-diagnosis)                                                    | [flow](flow.md#2-basic-lifecycle), [flow](flow.md#5-dispatcher-recovery-layer)                                                                                        | [Dispatcher](agent/dispatcher.md)            | `apps/dispatcher/src/`                               |
| `running` stuck                   | [state-model](state-model.md#8-patterns-prone-to-stalls-initial-diagnosis)                                                    | [flow](flow.md#2-basic-lifecycle), [flow](flow.md#6-worker-failure-handling)                                                                                          | [Worker/Tester/Docser](agent/worker.md)      | `apps/worker/src/`                                   |
...
| `issue_linking` stuck             | [state-model](state-model.md#2-task-block-reason), [state-model](state-model.md#8-patterns-prone-to-stalls-initial-diagnosis) | [flow](flow.md#3-blocked-reasons-used-for-recovery)                                                                                                                   | [Planner](agent/planner.md)                  | `apps/planner/src/`                                  |
