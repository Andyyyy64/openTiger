export const FAILURE_CODE = {
  ...
  VERIFICATION_COMMAND_NO_TEST_FILES: "verification_command_no_test_files",
...
export type VerificationFailureCode =
  ...
  | typeof FAILURE_CODE.VERIFICATION_COMMAND_NO_TEST_FILES
  ...
  | typeof FAILURE_CODE.SETUP_OR_BOOTSTRAP_ISSUE
...
export const VERIFICATION_RECOVERY_FAILURE_CODES = [
  ...
  FAILURE_CODE.VERIFICATION_COMMAND_NO_TEST_FILES,
